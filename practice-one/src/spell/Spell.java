...
public class Spell {
    public static void attackingSpellsList(String args[]) {
        ArrayList<String> attackingSpells = new ArrayList<String>();
        attackingSpells.add("BOMBARDA MAXIMA {Attacks: 10, Magic Energy: 5}");
        attackingSpells.add("DESMAIUS {Attacks: 15, Magic Energy: 10}");
        attackingSpells.add("EXPULSO {Attacks: 20, Magic Energy: 15}");
